    ...
    <ul class="navbar-nav">
      <li class="nav-item ">
       ...
       <li class="nav-item active">
        <a class="nav-link" href="generate-test.jsp">Generate Test<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item ">
...
<br>
     ...
     <div class="container">
          ...
          <strong><center><h1 style="color: red; background-color: gray;">GENERATE TEST</h1></center></strong>
...
if(request.getAttribute("msg2")!=null)
{
    ...
    String errmsg=request.getAttribute("msg2").toString();
     ...
     <%
       ...
       <option name=<%=res.getString("course_name") %>> <%=res.getString("course_name") %> </option> 
        ...
        <br>
         ...
         <table>
         <tr>
     <center> <td><button type="submit" class="btn btn-primary" style="font-size:18px;">GENERATE TEST</button>
           </center>
           </td>
           <form action="student-panel.jsp">
            <center> <td><button type="submit" class="btn btn-primary" style="font-size:18px;">Go BACK</button>
           </center>
           </td>
           </form>
         </tr>
