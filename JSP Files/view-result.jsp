  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active ">
        <a class="nav-link" href="view-result.jsp">View Test Results<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<br>
     ...
     <div class="container">
          ...
          <strong><center><h1 style="color: red; background-color: gray;">VIEW ALL RSULTS</h1></center></strong>
  ...
  <div class="row">
    <div class="col-sm">
      ...
      <div class="col-sm">
          ...
          <button type="submit" class="btn btn-primary" name="submit-btn">View Results</button>
      </div>
...
<br>
  ...
  <thead>
    <tr id="tr">
      ...
      <th scope="col">Result</th>
        ...
        PreparedStatement ps= con.prepareStatement("select * from student_result where username=?");
  ...
  <tbody>
   ...
   <tr id="tr">
      ...
      <td> <%=res.getString("course")   %></td>
      <td> <%=res.getString("test_date")   %></td>
      <td> <%=res.getString("correct")   %></td>
      <td> <%=res.getString("wrong")   %></td>
      <td> <%=res.getString("total_marks")   %></td>
      <td> <%=res.getString("total_ques")   %></td>
      <td> <%=res.getString("score")   %></td>
      <td> <%=res.getString("result")   %></td>
    </tr>
