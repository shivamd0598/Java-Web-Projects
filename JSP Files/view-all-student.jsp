  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="view-all-student.jsp">View Students<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item ">
...
<br>
     ...
     <div class="container">
          ...
          <strong><center><h1 style="color: red; background-color: gray;">VIEW ALL STUDENTS</h1></center></strong>
         
         
         
    
         
        <form action="view-all-student.jsp" method="post">
