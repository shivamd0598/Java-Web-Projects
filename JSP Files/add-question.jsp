    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item ">
       ...
       <li class="nav-item active">
        <a class="nav-link" href="add-question.jsp">Add Questions<span class="sr-only">(current)</span></a>
      </li>
          <li class="nav-item">
...
<br>
     ...
     <div class="container">
          ...
          <strong><center><h1 style="color: red; background-color: gray;">ADD NEW QUESTION</h1></center></strong>
      ...
      <td>   <strong> Course: </strong></td> <td> <select name="course" id="gend"> 
       ...
       <option name=<%=res.getString("course_name") %>> <%=res.getString("course_name") %> </option> 
        ...
        <br>
           ...
           <tr>
        <td>    <strong>Question:</strong> </td><td><textarea id="ques" name="question"
          rows="5" cols="33" placeholder="Enter you question here...." style="background-color:darkgray; color:greenyellow;"> 
</textarea>
</td>
        </tr>
        
  <tr>
        <td>    <strong>   Option A:  </strong></td><td>  <input type="text" name="optiona" placeholder="Enter Option A"  id="pass" ></td> 
            
      </tr>
      <tr>      
           <td> <strong>   Option B:  </strong></td> <td> <input type="text" name="optionb" placeholder="Enter Option B"  id="repass" ></td>
        </tr>
         <tr>      
           <td> <strong>   Option C:  </strong></td> <td> <input type="text" name="optionc" placeholder="Enter Option C"  id="repass" ></td>
        </tr>
        
         <tr>      
           <td> <strong>   Option D:  </strong></td> <td> <input type="text" name="optiond" placeholder="Enter Option D"  id="repass" ></td>
        </tr>
        
       <tr>      
           <td> <strong>   Answer:  </strong></td> <td> <input type="text" name="answer" placeholder="Enter the answer"  id="repass" ></td>
        </tr>
