    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item active">
        <a class="nav-link" href="about-us.jsp">About-Us<span class="sr-only">(current)</span></a>
      </li>
    </ul>
  </div>
</nav>
...
<br>
<br>
        <strong><center><h1 style="color: red; background-color: black; font-size: 55px; text-decoration:underline">ABOUT  US</h1></center></strong>
<br>
<br>
