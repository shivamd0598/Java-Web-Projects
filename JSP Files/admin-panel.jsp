...
<br>
      ...
      <a href="student-registeration.jsp"><button type="button" class="btn btn-primary btn-lg btn-block" >ADD NEW STUDENT</button></a>
       <br>
       
        <a href="view-all-student.jsp"><button type="button" class="btn btn-secondary btn-lg btn-block" >VIEW STUDENT LIST</button></a>
        <br>
        <a href="add-question.jsp"><button type="button" class="btn btn-secondary btn-lg btn-block" >ADD NEW QUESTIONS</button></a>
        <br>
      
        <a href="delete-question.jsp"><button type="button" class="btn btn-secondary btn-lg btn-block" >DELETE QUESTION</button></a>
          <br>       
        <a href="delete-student.jsp"><button type="button" class="btn btn-secondary btn-lg btn-block" >DELETE STUDENT RECORD</button></a>
        <br>
        <a href="modify-details.jsp"><button type="button" class="btn btn-secondary btn-lg btn-block" >MODIFY STUDENT DETAILS</button></a>
       <br>
        <a href="add-course.jsp"><button type="button" class="btn btn-secondary btn-lg btn-block" >ADD COURSE</button></a>
        <br>
        <a href="delete-course.jsp"><button type="button" class="btn btn-secondary btn-lg btn-block" >DELETE COURSE</button></a>
