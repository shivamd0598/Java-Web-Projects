  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="admin-login-page.jsp">Admin Login <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    if(request.getAttribute("msg")!=null)
    {
        ...
        out.println("<h2 style='color:red';>"+errmsg+"</h2>");
         ...
         {
             //out.println(request.getAttribute("msg"));
             String errmsg=request.getAttribute("msg1").toString();
             out.println("<h2 style='color:red';>"+errmsg+"</h2>");
...
%>
        ...
        <form action="AdminLoginServlet" method="post">
            ...
            <strong>Username:</strong> <input type="text" name="username" placeholder="Enter your username here" id="uname">
        <br>
        <br>
  
            <strong>   Password:  </strong>  <input type="password" name="password" placeholder="Enter your password here"  id="pass" >
        <br>
        <br>
        <br>
  ...
  <div class="row">
    <div class="col-sm">
     ...
     <footer>
         <p><Strong><center>All Rights Reserved &copy; 2019. <br> Created By @Shivam Dhar</center></Strong></p>
