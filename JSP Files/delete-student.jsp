  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="delete-student.jsp">Delete Students <span class="sr-only">(current)</span></a>
      </li>
       <li class="nav-item">
...
<br>
     ...
     <div class="container">
          ...
          <strong><center><h1 style="color: red; background-color: gray;">DELETE STUDENTS</h1></center></strong>
...
<br>
  ...
  <tbody>
    ...
    <tr id="tr">
     ...
     <button type="submit" class="btn btn-primary" id="delete-btn" name="del-btn" value=<%=res.getString("username") %> >DELETE</button>
     </form>
