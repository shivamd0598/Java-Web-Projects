...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="index.jsp" style="background-color: gray; color: hotpink;"><strong>ONLINE EXAM PORTAL</strong></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="admin-login-page.jsp">Admin Login</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="student-login-page.jsp">Student Login</a>
      </li>
       <li class="nav-item active">
        <a class="nav-link" href="contact-us.jsp">Contact-Us <span class="sr-only">(current)</span></a>
      </li>
       <li class="nav-item">
...
<br>
        ...
        <h1 style="color:red; background-color: gray;"><u><center><strong>WELCOME TO ONLINE EXAM PORTAL</strong></center></u></h1>

<br>
<br>
<br>
<br>
        <strong><center><h1 style="color: red; background-color: black; font-size: 55px; text-decoration:underline">CONTACT  US</h1></center></strong>
<br>
<br>
...
<br>
        ...
        <a href="#"><button type="button" class="btn btn-primary btn-lg btn-block" >CONTACT NUMBER:(+91)9956-427-388</button></a>
        <br>
        <a href="#"><button type="button" class="btn btn-secondary btn-lg btn-block" >EMAIL-ID:SHIVAMDHAR532@GMAIL.COM</button></a>
        <br>
